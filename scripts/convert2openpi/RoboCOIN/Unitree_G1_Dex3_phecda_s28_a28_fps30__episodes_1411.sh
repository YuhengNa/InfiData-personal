...
"$PYTHON_BIN" "$CONVERTER" \
  ...
  --schema-key Unitree_G1_Dex3_phecda_s28_a28_fps30 \
  --camera-set cam_high,cam_left_wrist,cam_right_wrist \
  --data-dir "$RLDS_ROOT/Unitree_G1_Dex3_phecda_s28_a28_fps30_cam_high_cam_left_wrist_cam_right_wrist__episodes_1411" \
  --overwrite \
  "$@"
