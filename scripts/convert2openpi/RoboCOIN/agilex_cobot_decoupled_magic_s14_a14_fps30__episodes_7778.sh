...
"$PYTHON_BIN" "$CONVERTER" \
  ...
  --schema-key agilex_cobot_decoupled_magic_s14_a14_fps30 \
  --camera-set cam_high,cam_left_wrist,cam_right_wrist \
  --data-dir "$RLDS_ROOT/agilex_cobot_decoupled_magic_s14_a14_fps30_cam_high_cam_left_wrist_cam_right_wrist__episodes_7778" \
  --overwrite \
  "$@"
