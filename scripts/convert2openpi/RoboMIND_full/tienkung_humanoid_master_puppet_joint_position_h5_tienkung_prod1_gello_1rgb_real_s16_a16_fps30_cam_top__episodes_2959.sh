...
SCHEMA_KEY="tienkung_humanoid_master_puppet_joint_position_h5_tienkung_prod1_gello_1rgb_real_s16_a16_fps30_cam_top"
OUT_DIR="$RLDS_ROOT/${SCHEMA_KEY}__episodes_2959"
