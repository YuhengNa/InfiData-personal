...
SCHEMA_KEY="tienkung_humanoid_master_puppet_joint_position_h5_tienkung_xsens_1rgb_real_s14_a14_fps30_cam_top"
OUT_DIR="$RLDS_ROOT/${SCHEMA_KEY}__episodes_6126"
