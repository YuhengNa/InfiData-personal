...
SCHEMA_KEY="franka_sim_simulation_franka_joint_position_h5_simulation_sim_s8_a8_fps30_cam_front_external_cam_handeye_cam_left_external_cam_right_external"
OUT_DIR="$RLDS_ROOT/${SCHEMA_KEY}__episodes_11422"
