...
SCHEMA_KEY="tienkung_humanoid_tiangong_joint_position_h5_sim_tienkung_1rgb_sim_s38_a38_fps30_cam_chest_cam_head"
OUT_DIR="$RLDS_ROOT/${SCHEMA_KEY}__episodes_3965"
